...
const RULES: Array<[CardCluster, RegExp]> = [
  ["support", /\b(support|pylon|customer|refund|billing|churn|outreach|onboarding|ticket|priority customer|named customer|samplecoone|samplecotwo|samplecothree|samplecofour)\b/i],
